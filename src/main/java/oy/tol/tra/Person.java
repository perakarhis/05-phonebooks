...
public class Person implements Comparable<Person> {
    ...
    /**
     * TODO: Implement the method below to return a hash value.
     * YOU MUST NOT USE LIBRARY METHODS FOR THE HASH VALUE!!!
     * IT MUST BE CALCULATED FROM THE FIRST NAME AND LAST NAME
     * OF THE PERSON!
     * 
    ...
    public int hashCode() {
        int hash = 5381;
        // Implement hash function here. YOU MUST NOT USE LIBRARY METHODS FOR THE HASH VALUE!!!
        return hash;
    }
